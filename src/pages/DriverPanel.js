...
const DriverPanel = () => {
  ...
  const tileContent = ({ date, view }) => {
    ...
    const rangeOrders = dayOrders.filter(
      (o) => o.deliveryDateEnd && o.deliveryDateStart !== o.deliveryDateEnd,
    );
    const singleOrders = dayOrders.filter(
      (o) => !o.deliveryDateEnd || o.deliveryDateStart === o.deliveryDateEnd,
    );
                    ...
                    <div className="creator-section">
                      ...
                      {/* {order.createdBy?.email && (
                        <div className="detail-row">
                          ...
                          <span className="detail-value">
                            <a
                              href={`mailto:${order.createdBy.email}`}
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="order-summary">
                ...
                <p>
                  <strong>Клиент:</strong> {selectedOrder.client?.name}
                </p>
                <p>
                  <strong>Тел:</strong>
